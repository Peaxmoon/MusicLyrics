...
function initWebSocket() {
    ...
    window.sendSongDetails = () => {
        ...
        // Debugging: Log the currentDuration value and its type
        // console.log("[Music Sujjal Debug] currentDuration value:", currentDuration, "type:", typeof currentDuration);
